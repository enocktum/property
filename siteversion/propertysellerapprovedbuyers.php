    ...
    <main id="main" class="main">
            ...
            <nav>
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" style="text-transform:lowercase;">
                        <?php echo $firstname." View Property"; ?></li>
                </ol>
            </nav>
        </div>
        <!-- End Page Title -->
        ...
        <section class="section">
            <div class="content" style="background-color:white;width:100%;">
                <?php
                $buyerbidquery=mysqli_query($con,"select * from buyerbids where status='1'");
                $numofbids=mysqli_num_rows($buyerbidquery);
                if($numofbids>0)
                {
                  echo"
                  <h1 style='text-align:center;'>APPROVED BUYERS</h1>
                ...
                {
                  echo"<center><strong style='font-size:2em;'>There are no approved site visits</strong></center>";
                }
                ?>
            </div>
        </section>
