...
<body>
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active" style="text-transform:lowercase;"><?php echo $firstname." View approved site visits"; ?></li>
        </ol>
      </nav>
    </div>
	<!-- End Page Title -->
	...
	<section class="section">
		...
		<?php
        //show approved property buyers for site visit
        $query=mysqli_query($con,"select * from buyerbids where status='1'");
        while($data=mysqli_fetch_array($query))
        {
            $propertyincre=$data['propertyincre'];
            $propertyquery=mysqli_query($con,"select * from property where incre='$propertyincre' && system_users_incre='$usersincre'");
            ...
            {
                echo"You have not approved site visits for your employees currently.";
            }
        }
		?>
		</div>
