...
<body>
        ...
        <div class="pagetitle">
            ...
            <nav>
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" style="text-transform:lowercase;">
                        <?php echo $firstname." property pending site visit"; ?></li>
                </ol>
            </nav>
        </div>
        <!-- End Page Title -->
    ...
    if(isset($buyerbidid))
    {
        ...
        if($approvequery)
        {
            echo"
            <center>
            <div class='content' style='background:green;color:white;border:solid 3px black;'>
                <h1 style='color:white;font-weight:bold;margin-top:15px;margin-bottom:20px;'>SITE VISIT APPROVAL SUCCESSFUL</h1>
                <hr/>
                <p style='text-align:justify;margin-left:10px;margin-right:20px;margin-bottom:20px;'><strong>You have successfully approved the buyer for a site visit. The information will be relayed in his/her account with your <u>phonenumber</u> and <u>email</u> for further arrangement.</strong></p>
                <p>
            </div>
            </center>
            ";
