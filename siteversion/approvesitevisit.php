...
<body>
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active" style="text-transform:lowercase;"><?php echo $firstname." property pending site visit"; ?></li>
        </ol>
      </nav>
    </div>
	<!-- End Page Title -->
	...
	<section class="section">
		...
		<?php
    $buyerbidid=$_POST['buyerbidincre'];
    if(isset($buyerbidid))
    {
        $approvequery=mysqli_query($con,"update buyerbids set status='1' where incre='$buyerbidid'");
        if($approvequery)
        {
            echo"
            <div class='content' style='color:black;'>
                <h1 style='color:green;'>SITE VISIT APPROVAL SUCCESSFUL</h1>
                <p>You have successfully approved the buyer for a site visit. The information will be relayed in his/her account with your phonenumber and email for further discussion.</p>
                <p>
                You will get a phonecall or email from us or the buyer incase they need further information locating the site. The buyer or us will never ask you to disclose personal information, such as, M-Pesa information, bank details or personal accounts.
                </p>
            </div>
            ";
        }
