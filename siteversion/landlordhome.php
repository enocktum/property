<?php 
    ...
    $sitename=$dataq['name'];
	session_start();
	if(isset($_SESSION['landlord_session']))
	{
		$emailphone=$_SESSION['landlord_session'];
		include("../connection.php");
		$query=mysqli_query($con,"select * from system_users where ((phonenumber='$emailphone' || email='$emailphone') && user_type='landlord')");
...
<body>
	...
	<nav class="header-nav ms-auto">
	  ...
	  <li class="nav-item dropdown pe-3">
          ...
          <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow profile">
            ...
            <li>
              <a class="dropdown-item d-flex align-items-center" href="landlordlogout.php">
  ...
  <aside id="sidebar" class="sidebar">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" href="landlordhome.php">
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" href="landlordadd.php">
          <i class="bi-plus-circle"></i>
          <span>Add Rental House</span>
        </a>
      </li>
	  
	  <li class="nav-item">
        <a class="nav-link collapsed" href="landlordmanagerentals.php">
          <i class="bi-house-fill"></i>
          <span>Manage Rental House(s)</span>
        </a>
      </li>
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" href="landlordlogout.php">
