<?php 
    ...
    $sitename=$dataq['name'];
	session_start();
	if(isset($_SESSION['tenant_session']))
	{
		$emailphone=$_SESSION['tenant_session'];
		include("../connection.php");
		$query=mysqli_query($con,"select * from system_users where ((phonenumber='$emailphone' || email='$emailphone') && user_type='tenant')");
...
<body>
	...
	<nav class="header-nav ms-auto">
	  ...
	  <li class="nav-item dropdown pe-3">
          ...
          <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow profile">
            ...
            <li>
              <a class="dropdown-item d-flex align-items-center" href="tenantlogout.php">
  ...
  <aside id="sidebar" class="sidebar">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" href="tenanthome.php">
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" href="tenantbookrentalhouse.php">
	  ...
	  <li class="nav-item">
        <a class="nav-link collapsed" href="tenantapprovalstatus.php">
          <i class="bi-plus-circle"></i>
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" href="tenantlogout.php">
