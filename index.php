 ...
 @keyframes animate{
   ...
   100%{
    ...
    <body id="page-top">
        ...
        <!-- Mashead header-->
		<section style="position:fixed;top: 0px;left: 0px;width: 100%;border-radius:0px;margin-top:40px;margin-bottom:40px;">
		<?php
		...
		<select style="width:20%;" name="markettype" id="markettype" data-bs-toggle="dropdown" aria-expanded="false">
			<option>filter by market category</option>
			<option value="buy property">buy property</option>
			<option value="rent property">rent property</option>
		</select>
		<select style="width:20%;text-transform:lowercase;" class="countyidsearch" name="county" id="county" data-bs-toggle="dropdown" aria-expanded="false">
			<?php
					include"connection.php";
		...
		<select style="width:20%;text-transform:lowercase;" name="subcounty" class="subcounty" id="subcounty" data-bs-toggle="dropdown" aria-expanded="false">
			<option>select subcounty first to filter</option>
		</select>
		<input style="width:30%;text-transform:lowercase;" type="text" class="form-control" name="generalsearch" id="generalsearch" placeholder="type search key"/>
		<input style="width:10%;" type="submit" class="form-control btn btn-primary" value="Search" id="search" />
		</div>
		</center>
        ...
        <footer class="bg-black text-center py-5" >
            <div class="container px-5">
                <div class="text-white-50 small">
                    ...
                    <span class="mx-1">&middot;</span>
                    <a href="#!">FAQ</a>
					<button class="btn btn-success rounded-pill px-3 mb-2 mb-lg-0" data-bs-toggle="modal" data-bs-target="" style="position: fixed;bottom: 0;">
                        <span class="d-flex align-items-center">
                            <i class="bi-cart"></i>
							<?php
							if(isset($_COOKIE['cartitems']))
