...
<body>
	...
	<nav class="header-nav ms-auto">
	  ...
	  <li class="nav-item dropdown pe-3">
          ...
          <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow profile">
            ...
            <li>
              <a class="dropdown-item d-flex align-items-center" href="siteversion/propertybuyerlogout.php">
    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active"><?php echo $firstname." property submission for approval"; ?></li>
        </ol>
      </nav>
    </div>
	<!-- End Page Title -->
  ...
  <button class="btn btn-success rounded-pill px-3 mb-2 mb-lg-0" data-bs-toggle="modal" data-bs-target="" style="position: fixed;bottom: 0;right:0;">
                        <span class="d-flex align-items-center">
							...
							?>
                            <a href='cartcheckout.php' style='color:white;text-decoration:none;'><span class="small">CART(<?php echo $cartitems; ?>)</span></a>
                        </span>
                    </button>
    <div class="copyright">
	...
	<section class="section" style="background-color:white;color:black;text-align:center;">
        ...
        <fieldset>
           <table class="table table-responsive table-borderless">
                <br/><br/>
                <tr>
                    <td colspan="4"><a href="siteversion/login.php"><button style="width:95%;" class="btn btn-success">Login Here</button></a></td>
                    <td>or</td>
                    <td colspan="3"><a href="siteversion/register.php"><button style="width:95%;" class="btn btn-primary">Sign Up Here</button></a></td>
                </tr>
                <tr>
                    <td colspan="8">NB: remember to select (propertybuyer) as the user type when signing up or logging in</td>
                </tr>
           </table>
        </fieldset>
        <br/><br/>
